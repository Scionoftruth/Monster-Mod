package net.scionoftruth.monstermod.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MONSTER_BLOCK = registerBlock("monster_block",
            () -> new Block(Block.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.AMETHYST)));
